...
def degraded_causal_base_losses(
    ...
    *,
    ...
    """tc16 base loss with degraded audio targets excluded."""
    ...
    if (
        ...
        raise ValueError("tc16 family weighting requires uniform target counts")
...
def distillation_weight(
    ...
    *,
    ...
    """Resolve tc16's clean-teacher distillation weight."""
    if step < 0:
