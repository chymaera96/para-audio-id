...
def degraded_causal_base_losses(
    ...
    *,
    ...
    """tc15 base loss with degraded audio targets excluded."""
    ...
    if (
        ...
        raise ValueError("tc15 family weighting requires uniform target counts")
...
def distillation_weight(
    ...
    *,
    ...
    """Resolve tc15's clean-teacher distillation weight."""
    if step < 0:
